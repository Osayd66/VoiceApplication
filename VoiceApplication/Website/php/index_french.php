...
<head>
   ...
   <!-- Load the javascript -->
    <script src="scripts_french.js" defer></script>
...
<div class="split left">
    <div class="centered">
        <div class="Voting">
            <h2>Souhaitez-vous démarrer ou arrêter une session de vote?</h2>
        <!-- Start button-->    
            <div> 
...
<div class="Results">
    <h2>
Aimeriez-vous voir des résultats?</h2>
